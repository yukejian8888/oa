...
<div class="templatemo_content_left_section">
    ...
    <a href="http://jigsaw.w3.org/css-validator/check/referer"><img style="border:0;width:88px;height:31px"  src="" alt="Valid CSS!" vspace="8" border="0" /></a>
        ...
        <div id="templatemo_content_right">
            ...
            <h1>《<?php echo ($book["book_name"]); ?>》 <span>(作者：<?php echo ($book["author"]); ?>)</span></h1>
            <div class="image_panel">
                <?php if($book['image'] != 'null'and $book['image'] != ''): ?><img src="<?php echo ($book["image"]); ?>" alt="image" width="100" height="150"/>
                    <?php else: ?>
                    <img src="/Public/Home/images/templatemo_image_02.jpg" alt="image" width="100" height="150"/><?php endif; ?>
            </div>
          <h2>读书 - 看故事 - 做自己</h2>
            <ul>
	            <li>了解作者: <a href="/Home/Main/getAuthorAbstract/abstract/<?php echo ($book["author"]); ?>"><?php echo ($book["author"]); ?></a></li>
            	<li>推荐（<?php echo ($book["isgood"]); ?>）</li>
                <li>下载量: <?php echo ($book["download_times"]); ?></li>
                <li>BY <?php echo ($book["nickname"]); ?> | 分享于：<?php echo (date("Y-m-d H:i:s",$book["upload_time"])); ?></li>
            </ul>
            <h2><a href="<?php echo U('Book/download','id='.$book['book_id']);?>">点击下载</a> | <a href="javascript:;" onclick="isgood(<?php echo ($book['book_id']); ?>)">点击推荐</a></h2>
            <p style="font-size: 13px;"><?php echo ($book["intro"]); ?></p>
    ...
    function isgood(id){
        ...
        xhr.onreadystatechange=function(){
            if(xhr.readyState==4){
                ...
                location.href = '/Home/Main/details/id/'+id;
            }
        }
        xhr.open('get','/Home/Main/isGood/id/'+id);
        xhr.send(null);
    }
</script>
</html>